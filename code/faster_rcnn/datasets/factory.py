...
#Set up my plate dataset$
for code in ['PVW_CUT','WRM_CUT', 'PVW_WRM_CUT']:
    for split in ['train','val','trainval','test']:
        name = '{}_{}'.format(code,split)
        __sets[name] = (lambda split=split, code=code:
                        tjm_lpd(split, code))
