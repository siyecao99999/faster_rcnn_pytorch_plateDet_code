...
class tjm_lpd(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'lpd_' + year + '_' + image_set)
        self._year = year#PVW_CUT, WRM_CUT and so on
        self._image_set = image_set#train, trainval, test and so on
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'PlateDataSoft')
